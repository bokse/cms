...
class ScoringStore(object):
    ...
    def notify_callbacks(self, user, task, score, num_submissions, last_time):
        for call in self._callbacks:
            call(user, task, score, num_submissions, last_time)
    ...
    def create_submission(self, key, submission):
        ...
        self.notify_callbacks(submission.user, submission.task, new_score, len(score_obj._submissions), score_obj._history[-1][0] if len(score_obj._history) > 0 else 0)
